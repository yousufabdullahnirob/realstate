...
class Booking(models.Model):
    ...
    cancelled_by_admin = models.BooleanField(default=False)  # True if admin cancelled confirmed booking
    cancellation_reason = models.TextField(blank=True, null=True)  # Admin reason for cancellation
    final_payment_due_date = models.DateField(blank=True, null=True)  # Admin sets this for final payment/installments
    is_locked = models.BooleanField(default=False)  # True = user cannot cancel (payment received)
...
class Sale(models.Model):
    ...
    booking = models.OneToOneField(Booking, on_delete=models.SET_NULL, null=True, blank=True, related_name='sale')
