...
function ProjectDetails() {
  ...
  useEffect(() => {
      fetch(`http://127.0.0.1:8000/api/apartments/${id || 1}/`)
          .then(res => {
  ...
  if (loading) return <div style={{ padding: '50px', textAlign: 'center' }}>Loading project...</div>;
  if (!apartment) return <div style={{ padding: '50px', textAlign: 'center' }}>Project not found.</div>;
        ...
        <div className="hero-content">
          <div className="hero-content-left">
            ...
            <div className="hero-badges">
              ...
              <span className="hero-badge badge-type">Apartment</span>
          ...
          <div className="hero-content-right">
            <div className="hero-price-card">
              ...
              <div className="price"><span>$</span>{parseFloat(apartment.price).toLocaleString()}</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="info-bar">
        <div className="info-item">
          ...
          <div className="info-text">
            ...
            <div className="info-value">Cox Bazar, BD</div>
          </div>
        </div>
        <div className="info-item">
          <div className="info-icon">📐</div>
