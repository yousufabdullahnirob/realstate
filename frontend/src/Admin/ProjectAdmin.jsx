...
const ProjectAdmin = () => {
  ...
  const [currentProject, setCurrentProject] = useState(null); // project being edited/deleted
  const [formData, setFormData] = useState({ name: "", location: "", status: "Completed" });
    ...
    <div className="admin-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <a className="active" href="/project-admin">🏗 Projects</a>
          ...
          <table className="admin-table">
            ...
            <tbody>
              {projects.map(project => (
                <tr key={project.id}>
                  <td>{project.id}</td>
                  <td><img className="table-img" src={project.img} alt="" /></td>
                  <td>{project.name}</td>
          ...
          <div className="modal-overlay active">
            <div className="modal-box">
              ...
              <div className="modal-actions">
                ...
                <button className="confirm-delete-btn" onClick={saveProject}>Save</button>
              </div>
            </div>
          </div>
        ) : null}
